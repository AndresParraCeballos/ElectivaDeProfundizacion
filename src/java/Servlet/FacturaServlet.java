...
public class FacturaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            factura.setId_usuariovendedor(this.idVendedor);
            factura.setId_usuariocomprador(this.idComprador);
            factura.setFormaspagos_idformaspagos(this.formapago);
            
            
            boolean bol = impl.GuardarFactura(factura);
            if (bol) {
